...
export function Simple(props) {
  ...
  return (
    <group {...props} dispose={null}>
      <directionalLight  castShadow intensity={4} position={[-1.701, 7.049, -1.602]} rotation={[-1.806, -0.308, -2.24]} target={nodes['TriLamp-Back001'].target}>
        <primitive object={nodes['TriLamp-Back001'].target} position={[0, 0, -1]} />
      </directionalLight>
      <directionalLight castShadow intensity={2} ref={ref} position={[-7.233, 7.207, 4.936]} rotation={[-0.868, -0.723, -0.663]} target={nodes['TriLamp-Back002'].target}>
        <primitive object={nodes['TriLamp-Back002'].target} position={[0, 0, -1]} />
      </directionalLight>
      <pointLight castShadow intensity={4} decay={1} position={[4.171, 2.808, -0.496]} rotation={[-2.25, 0.727, 2.453]} />
      <pointLight castShadow intensity={4} decay={1} position={[-0.486, 3.889, -0.576]} rotation={[-2.25, 0.727, 2.453]} />
      <pointLight castShadow intensity={4} decay={1} position={[0.811, 0.701, 0.45]} rotation={[-0.388, 0.413, 0.162]} />
      <pointLight castShadow intensity={4} decay={1} position={[-1.672, 0.701, 0.45]} rotation={[-0.388, -0.734, -0.267]} />
      <pointLight castShadow intensity={1} decay={2} color="#ff9d00" position={[4.454, 3.717, -3.401]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight castShadow intensity={1} decay={2} color="#ff9d00" position={[4.997, 3.717, -3.401]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight castShadow intensity={1} decay={2} color="#ff9d00" position={[-5.577, 3.717, -3.401]} rotation={[-Math.PI / 2, 0, 0]} />
      <pointLight castShadow intensity={1} decay={2} color="#ff9d00" position={[-5.234, 3.717, -3.401]} rotation={[-Math.PI / 2, 0, 0]} />
    ...
    >
      <mesh castShadow geometry={nodes.Cube.geometry} material={materials.dull_mat} position={[-0.464, 1.233, -0.016]} />
      <mesh castShadow geometry={nodes.Cube002.geometry} material={materials['Material.001']} position={[-0.464, 1.271, -3.954]} />
      <mesh castShadow geometry={nodes.Cube003.geometry} material={materials.golden} position={[-0.463, 1.359, -0.017]} />
    </motion.group>
      ...
      <group position={[-0.418, 0.694, 0.001]} scale={[0.683, 0.594, 0.6]}>
        ...
        castShadow
         initial={{ scale: 0 }}
          animate={{ scale: 1 }}
          transition={{ duration: 1.5, delay: 0.3 }}
        geometry={nodes.Cylinder004_1.geometry} material={materials.dull_mat} />
      </group>
      <mesh geometry={nodes.Plane.geometry} receiveShadow material={materials.bg} position={[-0.6, -0.5, -2]} scale={[-5, -8.614, -1.223]} />
...
initial={{ rotate: 360, y: -300, opacity: 0 }}
      ...
      <group position={[3.746, 0.013, 0.012]} rotation={[0, -1.571, 0]} scale={0.018} ref={chair_right}>
        ...
        castShadow
         initial={{ rotate: 360, z: -300, opacity: 0 }}
          animate={{ rotate: 0, z: 0, opacity: 1 }}
          transition={{ duration: 1.5, delay: 1.5, damping: 0.5 }}
        geometry={nodes.meshChair002_2.geometry} material={materials['Material.001']} />
      </group>
      <group position={[-4.642, 0.013, 0.012]} rotation={[0, 1.571, 0]} scale={0.018} ref={chair_left}>
        ...
        castShadow
         initial={{ rotate: 360, z: -300, opacity: 0 }}
          animate={{ rotate: 0, z: 0, opacity: 1 }}
          transition={{ duration: 1.5, delay: 1.5, damping: 0.5 }}
        geometry={nodes.meshChair001_2.geometry} material={materials['Material.001']} />
      </group>
      ...
      <group position={[-0.472, 1.368, 0]} scale={0.026} ref={candles1}>
        ...
        geometry={nodes.Mesh002_2.geometry} material={materials.dull_mat} />
      </group>
      <group position={[0.953, 1.368, 0]} scale={0.026} ref={candles2}>
        ...
        geometry={nodes.Mesh003_2.geometry} material={materials.dull_mat} />
      </group>
      <group position={[-1.907, 1.368, 0]} scale={0.026} ref={candles3}>
        ...
        geometry={nodes.Mesh004_2.geometry} material={materials.dull_mat} />
      </group>
      ...
      <group position={[-0.289, 3.774, -3.656]} rotation={[-Math.PI / 2, Math.PI / 2, 0]} scale={[0.035, 0.035, 0.044]}>
        ...
        geometry={nodes.lamp_5.geometry} material={materials.clearMarble} />
      </group>
      <mesh geometry={nodes.Cube001.geometry} material={materials.dull_mat} position={[-1, -0.43, 0]} scale={[-2, 1, 1]}/>
    </group>
  )
}
